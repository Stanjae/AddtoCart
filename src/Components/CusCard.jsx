...
const CusCard = ({item}) => {
    const {Addto, store} = useContext(ShopContext);

    const peQty = store?.find(product => product.id === item.id)
  ...
  return (
    <div className="block rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
      ...
      >
        <img className=" w-full h-60 rounded-t-lg" src={item?.image} alt={item?.title} />
        <a href="#!">
